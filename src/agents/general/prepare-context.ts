...
const AGENT_WHITELISTS: Record<string, readonly string[]> = {
  ...
  // Tier 3 specialists — org + input + brandVoice (for brand-aligned generation)
  "seo-agent":           ["organizationId", "input", "brandVoice"],
  "hook-writer":         ["organizationId", "input", "brandVoice"],
  "title-generator":     ["organizationId", "input", "brandVoice"],
  "thumbnail-creator":   ["organizationId", "input", "brandVoice"],
  "script-agent":        ["organizationId", "input", "brandVoice"],
  "caption-writer":      ["organizationId", "input", "brandVoice"],
  "hashtag-optimizer":   ["organizationId", "input", "brandVoice"],
  "thread-writer":       ["organizationId", "input", "brandVoice"],
  "article-writer":      ["organizationId", "input", "brandVoice"],
  "trend-scout":         ["organizationId", "input", "brandVoice"],
  "engagement-responder": ["organizationId", "input", "brandVoice"],
  "analytics-reporter":  ["organizationId", "input", "brandVoice"],
  "content-repurposer":  ["organizationId", "input", "brandVoice"],
  "quality-scorer":      ["organizationId", "input", "brandVoice"],
  "variation-orchestrator": ["organizationId", "input", "brandVoice"],
  "brand-persona":       ["organizationId", "input", "brandVoice"],
  "viral-teardown":      ["organizationId", "input", "brandVoice"],
